...
# Data[Data$Group=='MS'&Data$ml_stage==0,"Group_subtype"]='B0';
# Data[Data$Group=='MS'&Data$ml_subtype==0&Data$ml_stage>0,"Group_subtype"]='B1';
# Data[Data$Group=='MS'&Data$ml_subtype==1&Data$ml_stage>0,"Group_subtype"]='B2';
# Data[Data$Group=='MS'&Data$ml_subtype==2&Data$ml_stage>0,"Group_subtype"]='B3';
...
Data_fl<-read.csv('D:/ZZZ/Manuscripts/Subtyping/Sustain_results/Results/follow_up/newMSeval.csv',header = TRUE)
...
Data_fl[Data_fl$Group=='MS'&Data_fl$ml_stage==0,"Group_subtype"]='MS-NA';
Data_fl[Data_fl$Group=='MS'&Data_fl$ml_subtype==0&Data_fl$ml_stage>0,"Group_subtype"]='MS-SC';
Data_fl[Data_fl$Group=='MS'&Data_fl$ml_subtype==1&Data_fl$ml_stage>0,"Group_subtype"]='MS-DGM';
Data_fl[Data_fl$Group=='MS'&Data_fl$ml_subtype==2&Data_fl$ml_stage>0,"Group_subtype"]='MS-C';
...
Data_new[Data_new$Group_subtype=='MS-NA', 'Group_Index']=1;
Data_new[Data_new$Group_subtype=='MS-C', 'Group_Index']=2;
Data_new[Data_new$Group_subtype=='MS-SC', 'Group_Index']=3;
Data_new[Data_new$Group_subtype=='MS-DGM', 'Group_Index']=4;
